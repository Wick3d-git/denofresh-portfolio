...
export default function TypingAnimation() {
  ...
  useEffect(() => {
    ...
    commands.forEach((cmd, index) => {
      setTimeout(() => {
        ...
        setTimeout(() => {
          if (outputs[index]) {
            (outputs[index] as HTMLElement).style.transition = "opacity 0.5s ease";
  ...
  const handleSkillClick = (skill: string) => {
    const skillInfo = {
      python: "Advanced proficiency in Python for automation, data analysis, and web development",
      ...
      linux: "Strong Linux/Unix system administration and command-line expertise",
    };

    const info = skillInfo[skill as keyof typeof skillInfo] || "Skill information not available";
    ...
    <div ref={containerRef}>
      ...
      <div class="output">
        <div class="skills-icons">
          <a href="https://www.python.org/" target="_blank" onClick={() => handleSkillClick("python")}>
            <i class="fab fa-python" title="Python"></i>
          </a>
          <a href="https://www.w3.org/html/" target="_blank" onClick={() => handleSkillClick("html5")}>
            <i class="fab fa-html5" title="HTML5"></i>
          </a>
          <a href="https://www.w3.org/Style/CSS/Overview.en.html" target="_blank" onClick={() => handleSkillClick("css3")}>
            <i class="fab fa-css3-alt" title="CSS3"></i>
          </a>
          <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank" onClick={() => handleSkillClick("js")}>
            <i class="fab fa-js-square" title="JavaScript"></i>
          </a>
          <a href="https://www.kernel.org/" target="_blank" onClick={() => handleSkillClick("linux")}>
